...
subset_d_100222 = subset(dev_stat_extended2, Device_id == 100222)
subset_d_107943 = subset(dev_stat_extended2, Device_id == 107943)
subset_d_103013 = subset(dev_stat_extended2, Device_id == 103013)

subset_37590 = subset(dev_stat_extended2, adid == 37590)
subset_34121 = subset(dev_stat_extended2, adid == 34121)
subset_35772 = subset(dev_stat_extended2, adid == 35772)
subset_36389 = subset(dev_stat_extended2, adid == 36389)
subset_36388 = subset(dev_stat_extended2, adid == 36388)
subset_36390 = subset(dev_stat_extended2, adid == 36390)
subset_36413 = subset(dev_stat_extended2, adid == 36413)
subset_37552 = subset(dev_stat_extended2, adid == 37552)
subset_33068 = subset(dev_stat_extended2, adid == 33068)

usable_ads = subset(nb_of_devices, x >= 80)
#from usable ads table
subset_35605 = subset(dev_stat_extended2, adid == 35605)
subset_37597 = subset(dev_stat_extended2, adid == 37597)
subset_36387 = subset(dev_stat_extended2, adid == 36387)
